...
namespace PieShop.Api.Migrations
{
    ...
    [Migration("20201109212226_benefints")]
    partial class benefints
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PieShop.Shared.Benefit", b =>
                {
            ...
            modelBuilder.Entity("PieShop.Shared.EmployeeBenefit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PieShop.Shared.EmployeeBenefit", b =>
                {
                    b.HasOne("PieShop.Shared.Benefit", "Benefit")
                        .WithMany()
                        .HasForeignKey("BenefitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PieShop.Shared.Employee", "Employee")
                        .WithMany()
